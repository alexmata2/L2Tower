...
local ClassesContainer = {
	Magic = {
		...
		Nuker = {
			...
			{ 182, "Wizard" },	-- Ertheia Wizard		
			{ 185, "Wizard" },	-- Cloud Breaker
			{ 187, "Wizard" },	-- Stratomancer
			{ 189, "Wizard" },	-- Sayha's Seer
...
local BuffsContainer = {
	...
	Sonata = {
		...
		Prevailing = {
			...
			LengthToMinTimeLeftMultiplier = nil,
			Length = nil,
			Skills = { 11607,11610,11600,11529 },
			NeedTarget = false,
			Buffs = {
		...
		Daring = {
			...
			LengthToMinTimeLeftMultiplier = nil,
			Length = nil,
			Skills = { 11608,11611,11601,11530 },
			NeedTarget = false,
			Buffs = {
				11530,	-- Daring Sonata
		...
		Refreshing = {
			...
			LengthToMinTimeLeftMultiplier = nil,
			Length = nil,
			Skills = { 11609,11612,11602,11532 },
			NeedTarget = false,
			Buffs = {
	...
	Protection = {
		...
		Mental = {
			...
			Buffs = {
				...
				11567,  -- Mental Attack Resistance
			},
		},
	},
	Harmony = {
